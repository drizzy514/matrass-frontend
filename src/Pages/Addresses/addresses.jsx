...
function Addresses() {
  ...
  // hooks
  const { message, setBody, method, setMethod } = useFetch("/addlocations");
      ...
      {address && address.length ? (
        <table>
          ...
          <tbody>
            {address.map((a) => {
              return (
                <tr key={a.locations_city}>
                  <td>{a.locations_city}</td>
                  <td>
                    {a.locations_description}
                  </td>
                  <td>
                    <a
                      href={`https://maps.google.com/?q=${a.locations_city},${a.locations_city}`}
                      target="_blank"
                      rel="noreferrer"
                    >

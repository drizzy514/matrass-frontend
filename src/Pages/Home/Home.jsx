...
import LocationImg from "../../Components/LocationImg/LocationImg";
...
import Contacted from "../../Components/Contacted/Contacted";
...
const Home = () => {
  ...
  useEffect(()=> {
      fetch('https://matras-backend-g1.herokuapp.com/technologies')
    ...
    <>
      <section className="hero" id="hero-id">
        <div className="container--home">
          <MainHeader modal={modalim} setModal={setModalim} />
      ...
      <section className="statistics ">
        <div className="container--home">
          <ul className="statistics-list">
           ...
           return   (
                <>
               <li  key={i}  className="statistics-list__item">
              <h1 className="statistics-title">{i.info_year}</h1>
              <p className="statistics-description">yillik tajriba</p>
            </li>
            <li key={i} className="statistics-list__item">
              <h1 className="statistics-title">{i.info_users}</h1>
              <p className="statistics-description">mamnun mijozlar</p>
            </li>
            <li key={i}   className="statistics-list__item">
              <h1 className="statistics-title">{i.info_garanty}</h1>
              <p className="statistics-description">yillik kafolat</p>
            </li>
            <li key={i}   className="statistics-list__item">
              <h1 className="statistics-title">{i.info_time}</h1>
        ...
        <div className="container--home">
          ...
          <ul className="technologies">
            {technologies.map((t)=> {
              return (
                <>
             <li key={t.technologies_id} className="technologies__item">
              <p className="technologies__title">{t.technologies_i_name}</p>
              <img
                src={t.technologies_img}
                data-url={t.technologies_video}
                onClick={clickPlay}
      ...
      <section className="address" id="address">
        <div className="container--home">
          <div className="address-info">
            ...
            <LocationInfo address={addressSlider} />
          </div>
          <LocationImg address={addressSlider} />
        </div>
      </section>
      <Contacted />
      <Footer />
